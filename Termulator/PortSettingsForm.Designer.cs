namespace Termulator
{
	partial class PortSettingsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.StripHighBitCheckBox = new System.Windows.Forms.CheckBox();
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.StripHighBitCheckBox);
			...
			// 
			// StripHighBitCheckBox
			// 
			this.StripHighBitCheckBox.AutoSize = true;
			this.StripHighBitCheckBox.Location = new System.Drawing.Point(21, 53);
			this.StripHighBitCheckBox.Name = "StripHighBitCheckBox";
			this.StripHighBitCheckBox.Size = new System.Drawing.Size(87, 17);
			this.StripHighBitCheckBox.TabIndex = 4;
			this.StripHighBitCheckBox.Text = "Strip High Bit";
			this.StripHighBitCheckBox.UseVisualStyleBackColor = true;
			// 
		...
		private System.Windows.Forms.CheckBox StripHighBitCheckBox;
	}
}